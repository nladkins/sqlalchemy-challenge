...
# Route to search for members - """ This is a description of the function itself or a document string """
...
def justice_league_character(real_name):
    ...
    # If character does not exist, return the following as part of your "for loop".
